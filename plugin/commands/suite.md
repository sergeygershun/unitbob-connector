...
Do this:
1. Run `npx -y --loglevel=error unitbob@0.1.8 suite-prepare`. This confirms the runtime is supported
...
4. Run `npx -y --loglevel=error unitbob@0.1.8 put-suite-build` to upload the finished suite.
