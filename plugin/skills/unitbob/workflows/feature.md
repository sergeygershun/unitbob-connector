...
Do this:
1. Run `npx -y --loglevel=error unitbob@0.7.9 feature-prepare`.
...
3. Write your answer to the `output_path` the request names
   ...
   answer.
4. Run `npx -y --loglevel=error unitbob@0.7.9 put-feature`. It records the
...
feature and the code come later, in other workflows, when the user asks.
