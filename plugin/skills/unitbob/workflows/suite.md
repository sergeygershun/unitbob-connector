...
1. Run `npx -y --loglevel=error unitbob@0.6.2 suite-prepare` with exactly one
...
5. Run `npx -y --loglevel=error unitbob@0.6.2 validate-worker-plan`. If
...
6. Seed every planned slice's checkpoint before fan-out. Write
   ...
   `npx -y --loglevel=error unitbob@0.6.2 validate-worker-checkpoints` here,
...
7. Use the same named role on both Claude Code and Codex: `unitbob:suite-worker`
   ...
   `npx -y --loglevel=error unitbob@0.6.2 codex-install`, then tell the user to
...
8. Run `npx -y --loglevel=error unitbob@0.6.2 validate-worker-checkpoints` after
...
10. Run `npx -y --loglevel=error unitbob@0.6.2 validate-build` after assembly. It
...
11. Run `npx -y --loglevel=error unitbob@0.6.2 run-local` once for the assembled
...
13. If behavioral is a `build_error`, skip review and keep the structural peer.
    Otherwise run
    `npx -y --loglevel=error unitbob@0.6.2 suite-review-prepare`. It runs and binds
...
15. Run `npx -y --loglevel=error unitbob@0.6.2 put-suite-build` exactly once. It
