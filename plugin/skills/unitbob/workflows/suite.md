...
1. Run `npx -y --loglevel=error unitbob@0.6.3 suite-prepare` with exactly one
...
7. Use the same named role on both Claude Code and Codex: `unitbob:suite-worker`
   ...
   `npx -y --loglevel=error unitbob@0.6.3 codex-install`, then tell the user to
...
8. Run `npx -y --loglevel=error unitbob@0.6.3 validate-worker-checkpoints` after
...
10. Run `npx -y --loglevel=error unitbob@0.6.3 validate-build` after assembly. It
...
11. Run `npx -y --loglevel=error unitbob@0.6.3 run-local` once for the assembled
...
13. If behavioral is a `build_error`, skip review and keep the structural peer.
    Otherwise run
    `npx -y --loglevel=error unitbob@0.6.3 suite-review-prepare`. It runs and binds
...
15. Run `npx -y --loglevel=error unitbob@0.6.3 put-suite-build` exactly once. It
